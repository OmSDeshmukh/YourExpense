...
prompt = """I have extracted the following text and corresponding bounding boxes from an image of a bill using an OCR model. Based on the text provided, please extract and return only the values for the following four key pieces of information without any additional explanation or context:
